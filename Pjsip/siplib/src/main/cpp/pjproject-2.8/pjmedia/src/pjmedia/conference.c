...
PJ_DEF(pj_status_t) pjmedia_conf_adjust_rx_level(pjmedia_conf *conf,
                                                 unsigned slot,
                                                 int adj_level) {
    ALOGE("%s adjust rx level start level:%d",THIS_FILE,adj_level);
    struct conf_port *conf_port;
    ...
    ALOGE("%s adj_rx_level:%d",THIS_FILE,adj_level+NORMAL_LEVEL);
    /* Unlock mutex */
    pj_mutex_unlock(conf->mutex);
...
PJ_DEF(pj_status_t) pjmedia_conf_adjust_tx_level(pjmedia_conf *conf,
                                                 unsigned slot,
                                                 int adj_level) {
    ALOGE("%s adjust tx level start level:%d",THIS_FILE,adj_level);
    struct conf_port *conf_port;
    ...
    ALOGE("%s adj_tx_level:%d",THIS_FILE,adj_level+NORMAL_LEVEL);
