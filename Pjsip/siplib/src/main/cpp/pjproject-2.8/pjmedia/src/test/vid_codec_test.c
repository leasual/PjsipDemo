                              ...
                              pjmedia_vid_packing packing)
{
    ...
    ALOGE("%s  encode decode test: codec=%s, packing=%s",THIS_FILE,
    ...
    ALOGE("%s %s    starting codec test: %s<->%.*s %dx%d",THIS_FILE,
...
int vid_codec_test(void)
{
    ...
    ALOGE("%s Performing video codec tests..",THIS_FILE);
