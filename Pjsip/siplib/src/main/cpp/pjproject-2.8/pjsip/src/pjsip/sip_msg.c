...
pjsip_contact_hdr_shallow_clone(pj_pool_t *pool, const pjsip_contact_hdr *);
...
static pjsip_routing_hdr *
pjsip_routing_hdr_shallow_clone(pj_pool_t *pool, const pjsip_routing_hdr *r);
